...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Application = __webpack_require__(223);
	...
	var _SearchPage = __webpack_require__(248);

	var _SearchPage2 = _interopRequireDefault(_SearchPage);

	var _SavedPage = __webpack_require__(250);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ArticleList = __webpack_require__(244);
	...
	var Application = function (_Component) {
		...
		_createClass(Application, [{
			...
			value: function deleteArticle() {
				_helpers2.default.deleteArticle().then(function (response) {
			...
			value: function saveArticle(article) {
				...
				_helpers2.default.postArticle(article).then(function (data) {
			...
			value: function render() {
				...
				var savedArticles = _state.savedArticles;
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'menu well text-center' },
						_react2.default.createElement(
							'h1',
						...
						_react2.default.createElement(
							'button',
							{ className: 'btn btn-danger', onClick: this.deleteArticle },
							' *Delete Saved Articles Forever* '
						)
					),
					_react2.default.createElement(
						'div',
						...
						_react2.default.createElement(_ArticleList2.default, { articles: articles, saveArticle: this.saveArticle })
					)
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var helpers = {
		...
		deleteArticle: function deleteArticle() {
			...
			return axios.get('/api/remove').then(function (response) {
				console.log(response);
				return response;
			});
		},
		...
		postArticle: function postArticle(article) {
			...
			return axios.post('/api/post', { article: article }).then(function (results) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ArticleItem = __webpack_require__(245);
	...
	var ArticleList = function (_Component) {
		...
		_createClass(ArticleList, [{
			...
			value: function render() {
				...
				var saveArticle = _props.saveArticle;
				...
				return _react2.default.createElement(
					...
					articles.map(function (article) {
						if (article.type_of_material === 'News') return _react2.default.createElement(_ArticleItem2.default, { article: article, saveArticle: saveArticle });
					})
				);
			}
		}]);
	...
	var SavedPage = function (_Component) {
		...
		_createClass(SavedPage, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					'div',
					{ className: 'SavedPage text-center' },
					_react2.default.createElement(
						'div',
						{ className: 'row' },
						_react2.default.createElement(
